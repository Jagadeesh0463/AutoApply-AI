        ...
        {loading ? (
          ...
          <>
            <div className="bg-white border border-slate-200 rounded-2xl p-5">
              <p className="text-xs text-slate-500 font-medium uppercase tracking-wide mb-1">Emails Sent</p>
              <p className="text-3xl font-bold text-slate-900">{sent.length}</p>
              <p className="text-xs text-slate-400 mt-1">via Gmail OAuth</p>
            </div>

            <div className="bg-white border border-slate-200 rounded-2xl p-5">
              <p className="text-xs text-slate-500 font-medium uppercase tracking-wide mb-1">Total Apps</p>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-5 sm:col-span-2">
              <p className="text-xs text-slate-500 font-medium uppercase tracking-wide mb-1">Profile Completion</p>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5">
          ...
          {loading ? (
                ...
                .map((d: any) => (
                  <li key={d.id} className="flex items-center justify-between bg-slate-50 rounded-xl px-4 py-3 gap-3">
                    ...
                    <div className="flex flex-col items-end flex-shrink-0 gap-1">
                      ...
                      {d.created_at && (
                        <span className="text-xs text-slate-400">{relativeDate(d.created_at)}</span>
                      )}
                    </div>
                  </li>
                ))}
            ...
            <div className="text-center py-10">
              ...
              <Link href="/apply" className="inline-block mt-3 text-xs text-indigo-600 font-semibold hover:underline">
